...
if (isset($_POST['send'])) {
    $response = send_message($_POST, $name, $user);
    if ($response === true) {
...
<body>
    ...
    <div class=" w-full static md:ml-32 md:pl-44 drop-shadow-md p-4 md:w-[90%] ">
        <nav class="flex justify-between p-2 bg-[#f1f4f5] mb-5 ">
            ...
            <div class="flex items-center">
                <span onclick="move('chat.php?user=<?= $firstname ?>')" class="flex mx-5 items-center mb-2 mt-2"><i
                        class='bx bx-arrow-back bx-sm'></i></span>
                <div>
