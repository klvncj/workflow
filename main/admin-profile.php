    ...
    <div class=" w-full md:ml-32 md:pl-44 drop-shadow-md p-4 md:w-[90%] ">
        ...
        <form>
            <div class=" bg-[#fffafa] drop-shadow-md flex flex-col rounded-lg p-4" >
                <div><h1 class="flex text-xl mt-2 py-2 font-bold">Edit Profile</h1></div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2  flex gap-3 my-2">
                  <div id="form-group" class=" flex flex-col gap-1">
                      ...
                      <input type="text" placeholder="Firstname" name="firstname" class="w-80 md:w-96 bg-gray-200 p-2 border border-2 border-[#25769b] focus:border-[#25769b] rounded" value="<?=$firstname?>">
                     </div>
                     <div id="form-group" class="flex flex-col gap-1">
                      <label for="firstname" class="font-bold">LASTNAME</label>
                      <input type="text" placeholder="lastname" name="lastname" class="w-80 md:w-96 bg-gray-200 p-2 border border-2 border-[#25769b] focus:border-[#25769b]  rounded" value="<?=$lastname?>">
                     </div>
                </div>
                <div class=" grid grid-cols-1 md:grid-cols-2 flex gap-3 my-2">
                  <div id="form-group" class="flex flex-col gap-1">
                      <label for="firstname" class="font-bold">EMAIL</label>
                      <input type="text" placeholder="Firstname" name="firstname" class="w-80 md:w-96 bg-gray-200 p-2 border border-2 border-[#25769b] focus:border-[#25769b]  rounded" value="<?=$email?>">
                     </div>
                     <div id="form-group" class="flex flex-col gap-1">
                        <label for="firstname" class="font-bold">Position</label>
                        <input type="text" placeholder="position" name="position" class="w-80 md:w-96 bg-gray-200 p-2 border border-2 border-[#25769b] focus:border-[#25769b]  rounded" value="Admin">
                       </div>
                </div>
                <div class="grid grid-cols-1 md:grid-cols-2 flex gap-3 my-2">
                  <div id="form-group" class="flex flex-col gap-1">
                      <label for="firstname" class="font-bold">DEPARTMENT</label>
                      <input type="text" placeholder="position" name="position" class="w-80 md:w-96 bg-gray-200 p-2 border border-2 border-[#25769b] focus:border-[#25769b]  rounded" value="Managemnet">
                     </div>
                     <div id="form-group" class="flex flex-col gap-1">
                      <label for="firstname" class="font-bold">Profile Picture : <?=$profile_pic?></label>
                      <input type="file" name="lastname" class="w-80 md:w-96 bg-gray-200 h-11 p-1 border border-2 border-[#25769b] focus:border-[#25769b]  rounded" value="">
                     </div>
                </div>
               ...
               <div class="flex">
                <button class="w-24 mt-5 p-2 rounded-lg bg-teal-700 hover:bg-teal-500 duration-700" type="submit" name="update" disabled>Update</button>
               </div>
              </div>
           </form>
    </div>
